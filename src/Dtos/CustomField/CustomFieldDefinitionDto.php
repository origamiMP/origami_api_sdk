...
use OrigamiMp\OrigamiApiSdk\Exceptions\Dtos\CustomField\CustomFieldDefinitionDtoNotConstructableException;
 ...
 *
 * Distinct from CustomFieldDto, which represents a value already set on an entity
 * (Seller, User, ...) and comes from a different, nested JSON shape.
 */
class CustomFieldDefinitionDto extends ApiResponseDto
{
    use HasTimestamps;
    ...
    protected static function getDefaultNotConstructableException(
        ...
        return new CustomFieldDefinitionDtoNotConstructableException($msg, previous: $previous);
    }
